...
<body class="d-flex flex-column h-100">
    ...
    //$flightTicketResults = $connection->query("SELECT ticket_class.name, SUM(price) as classPrice FROM ticket_class ");
    ...
    <div class="container">
                ...
                <div class="card" style="width:100%">
                    ...
                    <div class="row card-body" ?>
                        ...
                        <div class="col">
                            ...
                            <span><?php echo $flightScheduleStatisticResult['totalRevenue'] ?> MYR</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row my-4">
        <?php
            } else if ($_GET['reportType'] == "Sales Report By Ticket Class") {
                echo "<h3 class=col>Monitoring Sales of Flights | Report</h3>";
        ?>
        </div>
        <div class="row">
                ...
                <?php foreach ($totalTickets as $ticketData) { ?>
                    <div class="row card-body" ?>
                        ...
                        <div class="col">
                            ...
                            <span><?php echo $ticketData['revenue'] ?> MYR</span>
                        </div>
                    </div>
                <?php } ?>
            </div>
