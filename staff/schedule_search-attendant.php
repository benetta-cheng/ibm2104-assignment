...
<?php require('../head.php');
      ...
      require('navbar.php'); ?>
<title>Flight Team | Search Flight Attendant</title>
</head> 

<body>
<div class = "container">
<h3>Flight Team | Search Flight Attendant</h3>
<p>Please enter the flight attendant's name or their staff id to search for a pilot</p>
<?php $scheduleID = $_GET['id']; ?>
<form action = "schedule_search-attendant.php" method = "get">
    <div class="form-row">
        <!-- Flight Number Search -->
        <div class="form-group col-md-6">
        <label for="attendantName">Flight Attendant's Name</label>
        <input type="text" class="form-control" name="attendantName">
        </div>
...
//Connection to database establish
    ...
    $staffQuery = "SELECT * FROM staff WHERE role = 2";
