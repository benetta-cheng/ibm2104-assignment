...
<head>
    ...
    require('navbar.php'); ?>
    <title>Flight Team | Search Pilot</title>
</head>

<body>
    <div class="container">
        <h3>Flight Team | Search Pilot</h3>
        <p>Please enter the pilot's name or their staff id to search for a pilot</p>
        <?php $scheduleID = $_GET['id']; ?>
        <form action="schedule_search-pilot.php" method="get">
            <div class="form-row">
                <!-- Flight Number Search -->
                <div class="form-group col-md-6">
                    <label for="pilotName">Pilot Name</label>
                    <input type="text" class="form-control" name="pilotName">
                </div>
